    ...
    switch ( $eggnews_widgets_field_type ) {
        ...
        ?>
            <p>
                ...
                <input class="widefat" id="<?php echo esc_attr ( $instance->get_field_id( $eggnews_widgets_name ) ); ?>" name="<?php echo esc_attr ( $instance->get_field_name( $eggnews_widgets_name ) ); ?>" type="text" value="<?php echo esc_html( $athm_field_value ); ?>" />
        ...
        ?>
            <p>
                <label for="<?php echo esc_attr( $instance->get_field_id( $eggnews_widgets_name ) ); ?>"><?php echo esc_html( $eggnews_widgets_title ); ?>:</label>
                <textarea class="widefat" rows="<?php echo intval( $eggnews_widgets_row ); ?>" id="<?php echo esc_attr( $instance->get_field_id( $eggnews_widgets_name ) ); ?>" name="<?php echo esc_attr ( $instance->get_field_name( $eggnews_widgets_name ) ); ?>"><?php echo esc_html( $athm_field_value ); ?></textarea>
            </p>
        <?php
            break;
        ...
        ?>
            <p>
                ...
                <div class="radio-wrapper">
                    ...
                    ?>
                        <input id="<?php echo esc_attr( $instance->get_field_id( $athm_option_name ) ); ?>" name="<?php echo esc_attr( $instance->get_field_name( $eggnews_widgets_name ) ); ?>" type="radio" value="<?php echo esc_html( $athm_option_name ); ?>" <?php checked( $athm_option_name, $athm_field_value ); ?> />
        ...
        ?>
            <p>
                <label for="<?php echo esc_attr( $instance->get_field_id( $eggnews_widgets_name ) ); ?>"><?php echo esc_html( $eggnews_widgets_title ); ?>:</label>
                <select name="<?php echo esc_attr( $instance->get_field_name( $eggnews_widgets_name ) ); ?>" id="<?php echo esc_attr( $instance->get_field_id( $eggnews_widgets_name ) ); ?>" class="widefat">
        ...
        ?>
            <p>
                <label for="<?php echo esc_attr( $instance->get_field_id( $eggnews_widgets_name ) ); ?>"><?php echo esc_html( $eggnews_widgets_title ); ?>:</label><br />
                <input name="<?php echo esc_attr( $instance->get_field_name( $eggnews_widgets_name ) ); ?>" type="number" step="1" min="1" id="<?php echo esc_attr( $instance->get_field_id( $eggnews_widgets_name ) ); ?>" value="<?php echo esc_html( $athm_field_value ); ?>" />
        ...
        ?>
            <div class="layout-image-wrapper">
                ...
                <img src="<?php echo esc_url( $eggnews_widgets_layout_img ); ?>" title="<?php echo esc_attr( 'Widget Layout', 'eggnews' ); ?>" />
            </div>
        <?php
            break;
...
function eggnews_widgets_updated_field_value( $widget_field, $new_field_value ) {
    ...
    if ( $eggnews_widgets_field_type == 'number') {
        return eggnews_sanitize_number( $new_field_value );

        // Allow some tags in textareas
    } elseif ( $eggnews_widgets_field_type == 'textarea' ) {
    ...
    } elseif ( $eggnews_widgets_field_type == 'url' ) {
