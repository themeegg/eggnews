...
class Eggnews_Ads_Banner extends WP_widget {
    ...
    ?>
            <div class="ads-wrapper <?php echo esc_attr( $eggnews_banner_size ); ?>">
                ...
                ?>
                    <a href="<?php echo esc_url( $eggnews_banner_url );?>" target="<?php echo esc_attr( $eggnews_banner_target ); ?>" rel="<?php echo esc_attr( $eggnews_banner_rel ); ?>"><img src="<?php echo esc_url( $eggnews_banner_image ); ?>" /></a>
                <?php
                    } else {
                ?>
