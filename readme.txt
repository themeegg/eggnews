...
Eggnews bundles the following third-party resources:
...
= 1.4.10 - 2018/06/10 =
	* Fix - Google adsence issue fix for banner add
	* Added - Google adsence option added in customizer
= 1.4.9 - 2018/05/30 =
...
= 1.4.7 - 2018/03/12 =
	* Added - Feature slider and block layout widgets multiple tag and multiple category filter added   
	* Fix - Minor design issue fix   
= 1.4.6 - 2018/03/07 =
...
= 1.4.3 - 2018/01/19 =
	...
	* Fix - Pagination on column archive design improve
= 1.4.2 - 2018/01/02 =
...
= 1.4.0 - 2017/12/10 =
	...
	* Fix - Logo design issue fix
	* Fix - Minor design related issue fix
		
= 1.3.10 - 2017/12/01 =
	* Fix - W3C Validation
	* Update - Font awesome update
	* Update - Bxslider update
	* Fix - Minor design issue fixes
	
= 1.3.9 - 2017/11/25 =
	* Fix - Header issue fixed
	* Fix - Archive page taxonomy description issue fixed
	* Fix - Resizable image issue fixed
...
= 1.3.7 - 2017/11/14 =
	...
	* Fix - Responsive nagivation issue resolved
	* Fix - Minor design issues

= 1.3.6 - 2017/11/08 =
	* Fix - Navigation responsiveness issue fixed
	* Fix - Post carousel responsiveness issue fixed
	* Fix - other design related issue fixed
	* Changed - Screenshot update
...
= 1.3.0 - 2017/09/15 =
	...
	* Some top header design enhancement
	* Font family changed 
	* Widget title and news title header design modify
	* Carousel issue fixed
	* Add one option on ticker (enable ticker in all pages or enable only on home page)
= 1.2.0 - 2017/09/10 =
...
= 1.1.0 =
    ...
    * Heading design modified
    * Single page comment section design optimize
= 1.0.0 =
    * Initial released
